 ...
 */
final class Version20251022103256 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Courriers ADD category VARCHAR(255) NOT NULL, CHANGE civilite civilite INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Courriers DROP category, CHANGE civilite civilite TINYINT(1) NOT NULL');
