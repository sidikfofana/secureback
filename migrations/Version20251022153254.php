 ...
 */
final class Version20251022153254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Documents DROP date_approved, CHANGE date_validated date_validated DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE Documents ADD CONSTRAINT FK_2041F02BC69DE5E5 FOREIGN KEY (validated_by_id) REFERENCES User (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE Documents ADD CONSTRAINT FK_2041F02B2D234F6A FOREIGN KEY (approved_by_id) REFERENCES User (id) ON DELETE SET NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE Documents ADD date_approved DATETIME DEFAULT NULL, CHANGE date_validated date_validated DATETIME DEFAULT NULL');
